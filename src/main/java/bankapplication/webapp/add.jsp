...
<body>
 <%
    ...
    if(rs.next())
    {
		...
		response.getWriter().println("<center>"+"<h1>"+"Your a/c no credited :"+totalbalance+" rupees"+"</h1>"+"</center>");
		System.out.println( "Your a/c no credited "+totalbalance+"  successfuly...");
	}
    else
    {
